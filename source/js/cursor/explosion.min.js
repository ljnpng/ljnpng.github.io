...
function setParticuleDirection(e) {
    ...
    return {x: e.x + n * Math.cos(t) /5, y: e.y + n * Math.sin(t) /5}
}

function createParticule(e, t) {
    var a = {};
    return a.x = e, a.y = t, a.color = colors[anime.random(0, colors.length - 1)], a.radius = 5, a.endPos = setParticuleDirection(a), a.draw = function () {
...
if (canvasEl) {
    var ctx = canvasEl.getContext("2d"), numberOfParticules = 10, pointerX = 0, pointerY = 0, tap = "mousedown",
